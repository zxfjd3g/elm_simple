<template>
  <div>
    ...
    <section class="animation_opactiy shop_back_svg_container" v-if="showLoading">
      <img src="../../common/images/shop_back_svg.svg">
    </section>
...
<script>
  ...
  import { msiteAdress, shopDetails, foodMenu, getRatingList, ratingScores, ratingTags } from 'api/getData'
    ...
    .menu_right {
      ...
      .menu_detail_header {
        ...
        .menu_detail_header_right {
          ...
          display: block;
          @include bis('../../common/images/icon_point.png');
