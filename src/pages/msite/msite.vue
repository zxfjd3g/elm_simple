<template>
  <div>
    ...
    <nav class="msite_nav">
      ...
      <img src="../../common/images/fl.svg" class="fl_back animation_opactiy" v-else>
    </nav>
...
<script>
  ...
  import {msiteAdress, msiteFoodTypes} from 'api/getData'
  ...
  export default {
    data() {
      return {
        geohash: '40.10038,116.36867', // city页面传递过来的地址geohash
